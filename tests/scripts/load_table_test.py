...
def get_test_name(index):
    ...
    return os.path.join(TEST_DIR, "load_table_test/load_table_test.sql")

def get_output_name(index):
    # Ignoring index as there is only one file
    return os.path.join(TEST_DIR, "load_table_test/load_table_output.txt")
...
def run():
    ...
    database_name = "load_table_test_db"
    score = 0.0
    ...
    for i in range(NUM_TESTS):
        ...
        # Prepare output file
        my_answer = "./tests/client_output/load_table_test_output.txt"
